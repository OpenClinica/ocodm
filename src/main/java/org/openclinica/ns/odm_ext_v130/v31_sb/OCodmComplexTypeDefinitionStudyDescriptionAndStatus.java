 ...
 *       &lt;sequence&gt;
 *         &lt;element name="StudySytemStatus" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text"/&gt;
 *         &lt;element name="PrincipalInvestigator" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text"/&gt;
 *         &lt;element name="DetailedDescription" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text" minOccurs="0"/&gt;
 *         &lt;element name="Sponsor" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text"/&gt;
 *         &lt;element name="Collaborators" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text" minOccurs="0"/&gt;
 *         &lt;element name="StudyPhase" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text"/&gt;
 *         &lt;element name="ProtocolType" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text" minOccurs="0"/&gt;
 *         &lt;element name="ProtocolVerificationDate" type="{http://www.cdisc.org/ns/odm/v1.3-sb}date" minOccurs="0"/&gt;
 *         &lt;element name="Purpose" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text" minOccurs="0"/&gt;
 *         &lt;element name="Duration" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text" minOccurs="0"/&gt;
 *         &lt;element name="Selection" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text" minOccurs="0"/&gt;
 *         &lt;element name="Timing" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text" minOccurs="0"/&gt;
 *         &lt;element name="Allocation" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text" minOccurs="0"/&gt;
 *         &lt;element name="Masking" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text" minOccurs="0"/&gt;
 *         &lt;element name="Control" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text" minOccurs="0"/&gt;
 *         &lt;element name="InterventionModel" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text" minOccurs="0"/&gt;
 *         &lt;element name="StudyClassification" type="{http://www.cdisc.org/ns/odm/v1.3-sb}text" minOccurs="0"/&gt;
 *         &lt;group ref="{http://www.openclinica.org/ns/odm_ext_v130/v3.1-sb}StudyDescriptionAndStatusElementExtension" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{http://www.openclinica.org/ns/odm_ext_v130/v3.1-sb}StudyDescriptionAndStatusAttributeExtension"/&gt;
 *       &lt;attGroup ref="{http://www.openclinica.org/ns/odm_ext_v130/v3.1-sb}StudyDescriptionAndStatusAttributeDefinition"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
