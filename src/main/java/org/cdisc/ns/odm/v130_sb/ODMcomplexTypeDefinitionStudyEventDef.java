 ...
 *         &lt;element ref="{http://www.cdisc.org/ns/odm/v1.3-sb}FormRef" maxOccurs="unbounded"/&gt;
 *         &lt;group ref="{http://www.cdisc.org/ns/odm/v1.3-sb}StudyEventDefElementExtension" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{http://www.cdisc.org/ns/odm/v1.3-sb}StudyEventDefAttributeExtension"/&gt;
 *       &lt;attGroup ref="{http://www.cdisc.org/ns/odm/v1.3-sb}StudyEventDefAttributeDefinition"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class ODMcomplexTypeDefinitionStudyEventDef {
    ...
    @XmlElement(name = "EventDefinitionDetails", namespace = "http://www.openclinica.org/ns/odm_ext_v130/v3.1-sb")
