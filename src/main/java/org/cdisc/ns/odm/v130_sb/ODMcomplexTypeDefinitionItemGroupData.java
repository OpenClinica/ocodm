 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.cdisc.org/ns/odm/v1.3-sb}AuditRecord" minOccurs="0"/>
 *         &lt;element ref="{http://www.cdisc.org/ns/odm/v1.3-sb}Signature" minOccurs="0"/>
 *         &lt;element ref="{http://www.cdisc.org/ns/odm/v1.3-sb}Annotation" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;choice>
 *           &lt;group ref="{http://www.cdisc.org/ns/odm/v1.3-sb}ItemDataGroup" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;group ref="{http://www.cdisc.org/ns/odm/v1.3-sb}ItemDataStarGroup" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/choice>
 *         &lt;group ref="{http://www.cdisc.org/ns/odm/v1.3-sb}ItemGroupDataElementExtension" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.cdisc.org/ns/odm/v1.3-sb}ItemGroupDataAttributeDefinition"/>
 *       &lt;attGroup ref="{http://www.cdisc.org/ns/odm/v1.3-sb}ItemGroupDataAttributeExtension"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class ODMcomplexTypeDefinitionItemGroupData {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "ItemDataTime", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataDurationDatetime", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataBase64Binary", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataAny", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataIntervalDatetime", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataInteger", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataString", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataHexBinary", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataFloat", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataBoolean", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataPartialTime", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataPartialDatetime", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataDate", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataIncompleteDatetime", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataURI", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataDatetime", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataBase64Float", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataHexFloat", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataPartialDate", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ItemDataDouble", namespace = "http://www.cdisc.org/ns/odm/v1.3-sb", type = JAXBElement.class, required = false)
    })
